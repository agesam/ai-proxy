...
動畫教材資料：\n${JSON.stringify(externalmaterialData)};`;
		...
		const QUSETION_TEMPLATE = `必須提供相關的主要資訊後，再透過以上資訊提出一個單選題（不多於4個選項），用以引導使用者進一步探索相關主題。
** 你的提問【絕對不可以】是開放式問題 **
...
2. 優先根據知識庫【早慧資料】的JSON數據內容來回答問題，當對話主題與【早慧資料】及【動畫教材資料】無關時，要盡力引導用戶返回與【動畫教材資料】相關的話題，例如：【如果想知道有**小丑魚**更多的小知識，可以參考O1單元一的《小丑魚、海葵和寄居蟹》喔！】。
